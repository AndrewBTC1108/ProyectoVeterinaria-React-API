...
export default function ModalVaccines() {
    const [pet_id, setPet_id] = useState('');
    const [name, setName] = useState('');
    const [date, setDate] = useState('');
    const [errors, setErrors] = useState([]);
    const {handleCloseModalVaccine, userId, createVaccine} = useAmorPorTi();
    ...
    return (
        <>
            ...
            <h1 className="text-center text-4xl font-black">Registrar Vacuna</h1>
